...
const modes: { id: AgentMode; label: string; description: string; icon: React.ElementType }[] = [
  {
    id: 'plan',
    label: 'Plan',
    description: 'Analyze and propose steps before doing work',
    icon: ClipboardList
  },
  {
    id: 'ask',
  ...
  },
  {
    id: 'agent',
    label: 'Agent',
    description: 'Produce concrete implementation-ready work',
    icon: Bot
  },
  {
    id: 'autonomous',
    label: 'Autonomous',
    description: 'Carry the task through with minimal guidance',
    icon: Rocket
  }
];
